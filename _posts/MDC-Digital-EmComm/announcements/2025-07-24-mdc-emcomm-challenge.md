---
layout: post
title: "MDC Digital EMCOMM Challenge, 7-10 August 2025"
date: 2025-07-24
categories: [mdc-emcomm-challenge]
author: "MDCWINLINK-1"
permalink: /mdc-emcomm-challenge/2025-07-24-mdc-digital-emcomm-challenge-7-10-august-2025/
...
The Target Station Lists will be sent to the MDC Winlink Distribution List, on or before, Tuesday, 5 August. Pay close attention to Target Station Lists to make your contacts. Fldigi Target Stations will be operating in an attended mode, consequently, their time on the air will be limited. Plan ahead to make a Homerun (see
...
Fldigi: You are simulating an ARESMAT operator deployed to a tornado disaster zone. Use the ICS-213 Form found in FLMSG and create a H&W status report message from a person in the disaster zone. Use Incident Name provided above, use subject: H&W EXERCISE MESSAGE, and include all of the addressee information provided above in the message text. Utilize the RRI Gold message texts (see attached) for the message. Address the form with all available contact information. Identify the subject as H&W EXERCISE MESSAGE. Approve and when ready, connect to the Target Station, click on AutoSend in the Flmsg top tabs to send your message. Wait on frequency for a message acknowledgment from the Target Station, etc..


## Flmsg Tips

(Recommended NBEMS Config.png attached).
